...
if (isset($_GET['id']) && (int)$_GET['id'] > 0) { #proper data must be on querystring
	...
	//the purpose of the int is to prevent anyone from injecting code. int will turn a string into a 0 and return an id of 0 which we do not have. 
	$myID = (int)$_GET['id']; #Convert to integer, will equate to zero if fails
} else { //send user to a safe page.
...
if ($foundRecord) { #records exist - show Survey
	...
	echo '<div align="center">There is no survey like this</div>';
	echo '<div align="center"><a href="' . VIRTUAL_PATH . 'surveys/surveys_list.php">Go Back to Surveys List</a></div>';
}
